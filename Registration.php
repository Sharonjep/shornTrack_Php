                ...
                <div class="col-md-5">
                    <div class="login-aside text-center  d-flex flex-column flex-row-auto">
                        ...
                        <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                            ...
                            <p>Experience the Powerful Agri Delivery Track System<br>By <a href="https://shorn.com">Shorn</a></p>
                                ...
                                <div class="card-1">
                                    ...
                                    <form action="register.php" method="POST" id="register-form">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="mb-1" for="val-firstname"><strong>First Name</strong></label>
                                            <input type="text" class="form-control" name="firstname" required placeholder="John">

                                        </div>

                                        <div class="form-group mb-3">
                                            <label class="mb-1" for="val-lastname"><strong>Last Name</strong></label>
