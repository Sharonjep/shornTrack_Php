...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-primary">product Details</b>
						<div class="row">
							<div class="col-sm-6">
								<dl>
									<dt>Wight:</dt>
					...
					<dl>
						<dt>Branch Accepted the product:</dt>
...
<script>
	$('#update_status').click(function(){
		uni_modal("Update Status of: <?php echo $reference_number ?>","manage_product_status.php?id=<?php echo $id ?>&cs=<?php echo $status ?>","")
	})
</script>