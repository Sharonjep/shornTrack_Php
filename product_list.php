	...
	<div class="card card-outline ">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-primary" href="./index.php?page=new_product">Add</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * from products $where order by  unix_timestamp(date_created) desc ");
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                    	<a  class="view view_product" data-id="<?php echo $row['id'] ?>">
		                          <i class="fas fa-eye"></i>
		                        </a>
		                        <a href="index.php?page=edit_product&id=<?php echo $row['id'] ?>" class="edit">
		                          <i class="fas fa-edit"></i>
		                        </a>
		                        <a type="button" class="delete  delete_product" data-id="<?php echo $row['id'] ?>">
...
<script>
	$(document).ready(function(){
		...
		$('.view_product').click(function(){
			uni_modal("product's Details","view_product.php?id="+$(this).attr('data-id'),"large")
		})
