    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-4">
        ...
        <?php endif; ?>
         ...
         <li class="nav-item dropdown">
            <a href="./index.php?page=new_product" class="nav-link nav-reports">
           ...
           <li class="nav-item dropdown">
            <a href="./index.php?page=product_list" class="nav-link nav-reports">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_product">
            ...
            <ul class="nav nav-treeview">
              ...
              ?>
              <li class="nav-item">
                <a href="./index.php?page=product_list&s=<?php echo $k ?>" class="nav-link nav-product_list_<?php echo $k ?> tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p><?php echo $v ?></p>
                </a>
              </li>
...
<li class="nav-item">
  <a href="https://shorn.com" class="nav-link" target="_blank">
